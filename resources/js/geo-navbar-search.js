...
$('#navbar-container').load('/resources/components/geo-navbar.html', function() {
    ...
    $('#searchbtn').on('click', function(e) {
        ...
        if (keyword) {
            window.location.href = '/geo/search.html?series=The+Syriac+Gazetteer&fullText=' + encodeURIComponent(keyword);
        }
    });
