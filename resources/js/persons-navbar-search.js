...
$('#navbar-container').load('/resources/components/persons-navbar.html', function() {
    ...
    $('#searchbtn').on('click', function(e) {
        ...
        if (keyword) {
            window.location.href = '/persons/search.html?series=The+Syriac+Biographical+Dictionary&fullText=' + encodeURIComponent(keyword);
        }
    });
