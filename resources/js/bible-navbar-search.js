...
$('#navbar-container').load('/resources/components/bible-navbar.html', function() {
    ...
    $('#searchbtn').on('click', function(e) {
        ...
        if (keyword) {
            window.location.href = '/bible/search.html?series=A+Guide+to+Syriac+Authors&fullText=' + encodeURIComponent(keyword);
        }
    });
