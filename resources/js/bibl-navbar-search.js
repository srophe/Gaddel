...
$('#navbar-container').load('/resources/components/bibl-navbar.html', function() {
    ...
    $('#searchbtn').on('click', function(e) {
        ...
        if (keyword) {
            window.location.href = '/cbss/search.html?series=Comprehensive+Bibliography+on+Syriac+Studies&fullText=' + encodeURIComponent(keyword);
        }
    });
