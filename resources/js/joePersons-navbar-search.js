...
$('#navbar-container').load('/resources/components/joePersons-navbar.html', function() {
    ...
    $('#searchbtn').on('click', function(e) {
        ...
        if (keyword) {
            window.location.href = '/johnofephesus/persons/search.html?series=Prosopography+to+John+of+Ephesus’s+Ecclesiastical+History&fullText=' + encodeURIComponent(keyword);
        }
    });
